After running the  following command in the qemu image
```
echo “hello_world” > /dev/faulty
```
I get the resulting kernel oops
```
...
[0000000000000000] pgd=0000000042088003, p4d=0000000042088003, pud=0000000042088003, pmd=0000000000000000
...
x21: 00000000004c9940 x20: ffffff8001fffa00 
...
x5 : ffffff8002003ce8 x4 : ffffffc008677000 
...
---[ end trace 55f53738e5ebe7c8 ]---
```

After executing the following command in /AESD/assignment-4-hwsingh27 to get the objdump
```
buildroot/output/host/bin/aarch64-linux-objdump -S buildroot/output/build/ldd-5b9dcc97309c53db61086ebb8fef3dc306437c32/misc-modules/faulty.ko
```
Objdump output
```
buildroot/output/build/ldd-5b9dcc97309c53db61086ebb8fef3dc306437c32/misc-modules/faulty.ko:     file format elf64-littleaarch64
...
```
Analysis of disassembly: faulty.o file is disassembled using objdump, here (faulty.write()) the code is trying to set the value of address pointed to by 0x1 to zero. This is the fault as reported by the kernel oops as NULL pointer dereference.
